...
public class Main {
    ...
    public static final int TOURNAMENT_SELECTION_SIZE = 3; //so nst chon loc ngau nhien
    ...
    public static void main(String[] args) {
        ...
        Population population = new Population (Main.POPULATION_SIZE, main.data).sortByFitness(); //thích nghi
